...
(6,'Minecraft Dungeons,Hero Edition',' takes the relatable and fun parts of the dungeon crawler genre - such as hunting for treasure chests, looting decent weapons, and cooperating to defeat a boss -- and simplifies them. The game, which includes fantasy violence, is rated for players age 10 and older','Xbox Game Studios', 2020,29.99 ,'10+'),
(7,'Cyberpunk 2077','the next big RPG from Witcher 3 developer CD Projekt RED, a sprawling sci-fi story about hackers, seedy criminals, and warring corporations. Originally, Cyberpunk was supposed to have released by now, but CD Projekt delayed it back in January','CD Projekt',2020 ,79.99 ,'17+'),
(8,'Call of Duty: Modern Warfare','it has been reworked for gameplay to be more tactical and introduces new features, such as a Realism mode that removes the HUD as well as a form of the Ground War mode that now supports 64 players.','Activision', 2019,59.99 ,'17+'),
(9,'Grand Theft Auto: San Andreas','Five years ago Carl Johnson escaped from the pressures of life in Los Santos, San Andreas... a city tearing itself apart with gang trouble, drugs and corruption. Where filmstars and millionaires do their best to avoid the dealers and gangbangers.','Rockstar Games', 2004, 16.94,'18+'),
(10,'Luigi''s Mansion 3','an action-adventure game, in which players control the character of Luigi from a fixed third-person perspective, as they capture ghosts across a large hotel setting.','Nintendo', 2019,79.96 ,'all ages')
